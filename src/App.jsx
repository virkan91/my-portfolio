      ...
      <section className=" drop-shadow-md">
        <div className="container max-w-[1100px] mx-auto pt-[80px] p-[20px] ">
          <div className="flex flex-col-reverse md:flex md:flex-row justify-between mt-[10px]  md:mt-[80px]  ">
            <div className="">
              <h1 className="text-[42px] md:text-[53px] text-center md:text-start font-bold mt-[40px] md:mt-0 ">
          ...
          <div className="flex flex-col">
            <div className="projects flex-col md:flex md:flex-row ">
              ...
              <div className="flex flex-col gap-5 mt-[30px] md:mt-0">
                ...
                <div className="flex  justify-center md:gap-[10px] items-center mt-[20px] flex-col md:flex-row gap-[10px] ">
